...
class LinkedInScraper(Scraper):
    ...
    def __init__(self, proxies: list[str] | str | None = None):
        ...
        self.seen_urls = set()
        self.path_history = "scrapping/historique/url_linkedin.txt"
    ...
    def scrape(self, scraper_input: ScraperInput) -> JobResponse:
        ...
        request_count = 0
        seconds_old = (
            scraper_input.start_hours * 3600 if scraper_input.start_hours else None
        )
        continue_search = (
